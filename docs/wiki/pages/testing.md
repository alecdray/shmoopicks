...
| E2E | Full user workflows through the browser | Playwright |
...
**Playwright** is the intended E2E framework. Tests interact with the UI the way a real user would — navigating pages, submitting forms, and asserting on rendered output.
